    ...
    getDesktopConfig: function () {
        ...
        return Ext.apply(ret, {
            ...
            shortcuts: Ext.create('Ext.data.Store', {
                ...
                data: [
                    { name: 'Grid Window', iconCls: 'grid-shortcut', module: 'grid-win', text: '测量文件' },
                    { name: 'Accordion Window', iconCls: 'accordion-shortcut', module: 'acc-win', text: '应用A' },
                    { name: 'Notepad', iconCls: 'notepad-shortcut', module: 'notepad', text: '应用B' },
                    { name: 'System Status', iconCls: 'cpu-shortcut', module: 'systemstatus', text: '应用C'}
                ]
            }),

            wallpaper: 'resources/images/wallpapers/bg8.jpg',
